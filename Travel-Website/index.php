                        ...
                        <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                            <ul class="navbar-nav text-uppercase">
                                <li class="nav-item active">
                                    <a href="index.php" class="nav-link tm-nav-link">Home <span class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="tm-row">
                ...
                <main class="tm-col-right">
                    <section class="tm-content">
                        <h2 class="mb-5 tm-content-title">Heading Here</h2>
                        <p class="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, quibusdam.
                            Lorem ipsum dolor sit amet.</p>
                        <hr class="mb-5">
                        <p class="mb-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta inventore
                            voluptatum nostrum quaerat deserunt vero facere!</p>
